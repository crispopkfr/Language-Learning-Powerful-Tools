  ...
  return (
    <div className="grid grid-cols-1 gap-6 animate-fade-in-up">
      ...
      <div className="relative group">
        ...
        <div className="bg-t-surface rounded-2xl shadow-sm border border-green-500/20 overflow-hidden">
          <div className="bg-green-500/10 px-6 py-4 border-b border-green-500/20 flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <button 
                  ...
                  className="text-xs flex items-center justify-center text-green-700 active:text-green-800 font-medium p-2 transition-all opacity-70 active:opacity-100 active:scale-95"
          ...
          <div className="p-8">
            <InteractiveText 
              content={analysis.correctedSentence} 
            ...
            {quickRewriteState.styles.map((style) => {
                ...
                return (
                    <button
                        ...
                        className={`
                            py-3 px-4 rounded-full text-sm font-medium transition-all duration-200 border relative overflow-hidden flex items-center justify-center gap-2 active:scale-95
                            ${isSelected
